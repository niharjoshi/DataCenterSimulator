...
import Simulations.MapReduceSimulation
import org.cloudsimplus.builders.tables.CloudletsTableBuilder

class MapReduceSimulationTest extends AnyFunSuite {

  // Setting simulation name for reference
  val simulation_name = "testing"

  // Initializing logger
  val logger = CreateLogger(classOf[MapReduceSimulationTest])
  ...
  test("BestFitVmAllocationSimulation test") {
    ...
    val simulation_status = MapReduceSimulation.Start()
