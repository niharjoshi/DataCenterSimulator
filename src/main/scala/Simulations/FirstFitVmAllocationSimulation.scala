...
class FirstFitVmAllocationSimulation

object FirstFitVmAllocationSimulation {


  def Start(): String = {
    // Setting simulation name for reference
    val simulation_name = "FirstFitVmAllocationSimulation"

    // Initializing logger
    val logger = CreateLogger(classOf[FirstFitVmAllocationSimulation])
