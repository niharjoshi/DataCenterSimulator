...
class RoundRobinVmAllocationSimulation

object RoundRobinVmAllocationSimulation {


  def Start(): String = {
    // Setting simulation name for reference
    val simulation_name = "RoundRobinVmAllocationSimulation"

    // Initializing logger
    val logger = CreateLogger(classOf[RoundRobinVmAllocationSimulation])
